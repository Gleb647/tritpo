...
Для тех частей приложения, в которых одни и те же данные совместно используются несколькими компонентами, полезно предусмотреть некое централизованное хранилище информации, расположенное на верхнем уровне иерархии.
Для улучшения масштабируемости серверного приложения следует четко определить зоны ответственности классов, а внедрение зависимостей осуществлять только с помощью интерфейсов в соответствии с принципом dependency inversion. 
